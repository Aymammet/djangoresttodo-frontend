...
async function createTask() {
        ...
        var addTaskUrl = "http://127.0.0.1:8000/tasks/"
...
async function editTask(id) {
        ...
        var editTaskUrl = "http://127.0.0.1:8000/tasks/"  + id + '/'
...
function deleteTask(id) {
    var deleteUrl = "http://127.0.0.1:8000/tasks/"  + id + '/'
    fetch(deleteUrl, {
        method : 'DELETE',
        headers: {
            'Authorization': 'Token ' + myStorage.getItem('token'),
...
async function changeState(state,task) {
    var editTaskUrl = "http://127.0.0.1:8000/tasks/"  + task.id + '/'
    response = await fetch(editTaskUrl, {
        method : 'PUT',
        headers: {
            'Authorization': 'Token ' + myStorage.getItem('token'),
...
async function order(parameter) {
    if (sort == 'asc') {
        var orderUrl = "http://127.0.0.1:8000/tasks?ordering=" + parameter;
        sort = 'desc'
    }
    else {
        var orderUrl = "http://127.0.0.1:8000/tasks?ordering=" + '-' + parameter;
